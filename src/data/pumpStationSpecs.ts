...
export const PUMP_STATION_SPECS: Record<string, PumpStationSpec> = {
  MBALIKA_INTAKE: {
    ...
    vfdFitted: false,
    ph1: { totalFlow_m3h: 26700, dutyHead_m: 44, motorKw: 485, pumpsWorking: 9, pumpsStandby: 1 },
    ph2: { totalFlow_m3h: 29000, dutyHead_m: 44, motorKw: 525, pumpsWorking: 9, pumpsStandby: 1 },
    notes: '640 MLD (26,700 m³/h) raw abstraction · 10 sets, 9 duty + 1 standby · soft-starters, algal-control ultrasonic system',
  },
  MBALIKA_WTP: {
    siteId: 'MBALIKA_WTP',
    ...
    vfdFitted: true,
    ph1: { totalFlow_m3h: 25333, dutyHead_m: 313, motorKw: 3210, pumpsWorking: 9, pumpsStandby: 1 },
    ph2: { totalFlow_m3h: 27000, dutyHead_m: 322, motorKw: 3639, pumpsWorking: 9, pumpsStandby: 1 },
    notes: '608 MLD (25,333 m³/h) treated water to Mabale B balancing reservoir at 313 m head · 10 high-lift sets, 9 duty + 1 standby',
  },
  MABALE_IBPS: {
    siteId: 'MABALE_IBPS',
